...
import { HomeOutlined, SkinOutlined, RocketOutlined, CoffeeOutlined, DribbbleOutlined, HighlightOutlined, TagsFilled, CodeOutlined, CopyOutlined, EditOutlined, LeftOutlined } from '@ant-design/icons';
    ...
    <div className='navbar'>
      <div className='container'>
        <div className='logo'>
          ...
          <span className="mobile-dec" style={{ fontSize: '.44rem', color: 'teal' }}><TagsFilled /> Share-Dairy</span>
